...
export const DURATION_CREDIT_TIERS: ReadonlyArray<{ maxSec: number; credits: number; label: string }> = [
  { maxSec: 600,      credits: 1,  label: "0–10 min"   },
  { maxSec: 1800,     credits: 2,  label: "10–30 min"  },
  { maxSec: 3600,     credits: 4,  label: "30–60 min"  },
  { maxSec: 7200,     credits: 8,  label: "60–120 min" },
  { maxSec: Infinity, credits: -1, label: "120+ min"   }, // blocked
];
