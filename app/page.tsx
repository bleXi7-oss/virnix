  ...
  return (
    <div className="relative w-full max-w-2xl">
      ...
      <div
        ...
        aria-hidden="true"
      />
      <div className="relative rounded-2xl border border-zinc-200/70 bg-white/55 p-8 backdrop-blur-xl shadow-[0_2px_8px_rgba(0,0,0,0.06),0_16px_56px_rgba(0,0,0,0.13),inset_0_1px_0_rgba(255,255,255,0.95)] transition-colors duration-300 dark:border-zinc-700/40 dark:bg-[#0a0a0a]/80 dark:backdrop-blur-xl dark:shadow-[0_0_0_1px_rgba(255,255,255,0.03),0_40px_100px_rgba(0,0,0,0.95),inset_0_1px_0_rgba(255,255,255,0.04)] md:p-12">
